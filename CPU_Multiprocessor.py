...
def worker(color_image, depth_image, edge_image, row, column, temp_worker_counter, return_dict):
    flag_result = isClose(color_image,depth_image,edge_image,row,column,1)
    return_dict[temp_worker_counter] = flag_result
...
def detection(color_image,depth_image,decf):
        ...
        for ct in range(268):
            ...
            if mask[row][column]>100:
                if (distance1>r) and (distance2>r):
                    ...
                    if(temp_worker_counter == 0):
                        p0 = mp.Process(target=worker,args=(color_image, depth_image, edge_image, row, column, temp_worker_counter, return_dict))
                    elif(temp_worker_counter == 1):
                        p1 = mp.Process(target=worker,args=(color_image, depth_image, edge_image, row, column, temp_worker_counter, return_dict))
                    elif(temp_worker_counter == 2):
                        p2 = mp.Process(target=worker,args=(color_image, depth_image, edge_image, row, column, temp_worker_counter, return_dict))
                    else:
                        p3 = mp.Process(target=worker,args=(color_image, depth_image, edge_image, row, column, temp_worker_counter, return_dict))
                    temp_worker_counter = temp_worker_counter + 1

                    if(temp_worker_counter==4):
                        temp_worker_counter = 0
                        p0.start()
                        p1.start()
                        p2.start()
                        ...
                        flag_result_0 = return_dict.values()[0]
                        flag_result_1 = return_dict.values()[1]
                        flag_result_2 = return_dict.values()[2]
                        flag_result_3 = return_dict.values()[3]
                        flag = (flag_result_0 or flag_result_1) or (flag_result_2 or flag_result_3)
    ...
    if(temp_worker_counter==3):
        ...
        flag_result_2 = return_dict.values()[2]
        # flag_result_3 = return_dict.values()[3]
        flag = (flag_result_0 or flag_result_1) or (flag_result_2)
    elif(temp_worker_counter==2):
        temp_worker_counter = 0
        p0.start()
        p1.start()
        ...
        flag_result_1 = return_dict.values()[1]
        # flag_result_2 = return_dict.values()[2]
        flag = (flag_result_0 or flag_result_1)
    elif(temp_worker_counter==1):
        temp_worker_counter = 0
        p0.start()
        # p1.start()
